...
## Descripción
Breve descripción del proyecto, incluyendo el problema identificado y la solución propuesta.
...
Gracias por tu interés en contribuir a nuestro proyecto. Sigue estos pasos para contribuir de manera efectiva.
